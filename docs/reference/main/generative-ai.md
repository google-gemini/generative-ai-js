...
|  [TunedModelState](./generative-ai.tunedmodelstate.md) | State of a tuned model. |

## Interfaces

|  Interface | Description |
|  --- | --- |
|  [ApiTuningHyperparameters](./generative-ai.apituninghyperparameters.md) | API response hyperparameters format (camelCase) |
...
|  [CreateTunedModelParams](./generative-ai.createtunedmodelparams.md) | Parameters for creating a tuned model. |
|  [CreateTunedModelResponse](./generative-ai.createtunedmodelresponse.md) | Response for tuned model creation operation. |
...
|  [ErrorDetail](./generative-ai.errordetail.md) | Error detail type for operation responses |
|  [ErrorDetails](./generative-ai.errordetails.md) | Details object that may be included in an error response. |
|  [ExamplesWrapper](./generative-ai.exampleswrapper.md) | Nested examples wrapper matching the API's exact structure |
...
|  [ListTunedModelsParams](./generative-ai.listtunedmodelsparams.md) | Parameters for listing tuned models. |
|  [ListTunedModelsResponse](./generative-ai.listtunedmodelsresponse.md) | Result of listing tuned models. |
...
|  [SnakeCaseTuningTaskDetails](./generative-ai.snakecasetuningtaskdetails.md) | Snake-case version of tuning task details for backward compatibility |
...
|  [TrainingData](./generative-ai.trainingdata.md) | Represents a collection of training examples. |
|  [TrainingExample](./generative-ai.trainingexample.md) | Represents a training example with input and output pair. |
|  [TunedModelMetadata](./generative-ai.tunedmodelmetadata.md) | Metadata about the tuned model. |
|  [TunedModelResponse](./generative-ai.tunedmodelresponse.md) | Response for getting a tuned model. |
|  [TuningHyperparameters](./generative-ai.tuninghyperparameters.md) | Hyperparameters for model tuning. |
|  [TuningOperationResponse](./generative-ai.tuningoperationresponse.md) | Response for a tuning operation. |
|  [TuningSnapshot](./generative-ai.tuningsnapshot.md) | Snapshot of tuning task progress |
|  [TuningTaskConfig](./generative-ai.tuningtaskconfig.md) | Configuration for the tuning task. |
|  [TuningTaskDetails](./generative-ai.tuningtaskdetails.md) | Tuning task details in API response |
...
|  [SnapshotDetailValue](./generative-ai.snapshotdetailvalue.md) | Snapshot detail value type that can be a string, number, boolean, or object |
